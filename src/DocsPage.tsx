...
const DOCS: DocSection[] = [
  ...
  },
  {
    ...
    pages: [
      {
        id: "free-and-paid",
        title: "Free and paid models",
        subtitle: "Which models cost nothing and how paid access works.",
        blocks: [
          { t: "p", v: "LocalOS uses a simple access model. Models under 2 GB download and run for free with no wallet and no payment required. Models 2 GB and above require a one-time USDC payment on the Base network before you can download them." },
          { t: "h2", v: "Pricing tiers" },
          { t: "table", headers: ["Model size", "Price", "What you need"], rows: [
            ["Under 2 GB", "Free", "Nothing. Just open the Models page and download."],
            ["2 GB to 3 GB", "15 USDC", "A Base wallet with at least 15 USDC."],
            ["3 GB to 4 GB", "20 USDC", "A Base wallet with at least 20 USDC."],
            ["4 GB and above", "25 USDC", "A Base wallet with at least 25 USDC."],
          ]},
          { t: "p", v: "Payment is one-time per model per wallet. Once a model is unlocked, you can download it, use it, and re-download it to any browser or device connected to the same wallet address. No subscription is ever required." },
          { t: "h2", v: "What free models cover" },
          { t: "list", items: [
            "Llama 3.2 1B: fast, efficient, good for simple tasks on any hardware",
            "Qwen 2.5 0.5B: smallest model in the catalog, runs on low-memory devices",
            "Gemma 2 2B: Google model, strong at reasoning relative to size",
          ]},
          { t: "note", kind: "info", v: "Free models are fully functional. They have no feature restrictions. The only difference from paid models is size and the capability that comes with scale." },
          { t: "h2", v: "What paid models add" },
          { t: "p", v: "Larger models produce higher-quality output on complex tasks including coding, multi-step reasoning, long documents, and detailed analysis. If you are doing serious work with LocalOS, a 7B or 13B model will produce substantially better results than a 1B model." },
        ],
      },
      {
        id: "wallet-setup",
        title: "Connecting a wallet",
        subtitle: "How to link a Base wallet to unlock paid models.",
        blocks: [
          { t: "p", v: "To unlock a paid model you need a wallet that supports the Base network. Any EVM-compatible wallet works including MetaMask, Coinbase Wallet, and WalletConnect-compatible wallets." },
          { t: "h2", v: "How to connect" },
          { t: "list", items: [
            "Open the Models page at localos.xyz/models",
            "Click the Connect Wallet button at the top of the page",
            "Choose your wallet from the list and approve the connection",
            "Your wallet address appears in the button once connected",
            "Find a paid model and click Unlock to begin the payment process",
          ]},
          { t: "h2", v: "Which network to use" },
          { t: "p", v: "LocalOS accepts USDC on the Base network only. Make sure your wallet is on Base before sending. Payments sent on other networks will not be detected and cannot be refunded." },
          { t: "note", kind: "warn", v: "Always verify the deposit address shown in the payment modal before sending. Each session generates a fresh address. Send the exact amount shown." },
          { t: "h2", v: "Getting USDC on Base" },
          { t: "p", v: "You can acquire USDC on Base through Coinbase, bridge from Ethereum mainnet using the official Base Bridge at bridge.base.org, or swap on any DEX that supports Base such as Uniswap or Aerodrome." },
        ],
      },
      {
        id: "payment-process",
        title: "How payment works",
        subtitle: "The deposit flow, on-chain confirmation, and permanent access.",
        blocks: [
          { t: "p", v: "When you click Unlock on a paid model, LocalOS generates a fresh deposit address for your session. You send the exact USDC amount to that address on Base. The backend monitors the Base blockchain and confirms your payment automatically." },
          { t: "h2", v: "Step by step" },
          { t: "list", items: [
            "Click Unlock on any paid model",
            "A payment modal opens showing the exact USDC amount and a deposit address",
            "Send exactly that amount of USDC on Base to the deposit address",
            "The modal polls for confirmation automatically, usually within 30 to 60 seconds",
            "Once confirmed, the model unlocks and you can download it immediately",
          ]},
          { t: "h2", v: "Session expiry" },
          { t: "p", v: "Each payment session has a time limit shown as a countdown in the modal. If the session expires before you send, close the modal and click Unlock again to generate a new address. Your previous send will be credited if it arrives within the monitoring window." },
          { t: "h2", v: "Permanent access" },
          { t: "p", v: "Access is permanently linked to your wallet address. If you clear your browser, switch devices, or revisit the Models page months later, connect the same wallet and all previously unlocked models will show as Unlocked automatically. You never pay twice for the same model on the same wallet." },
          { t: "note", kind: "tip", v: "Payments are processed fully on-chain on Base. LocalOS does not store any payment credentials and never has custody of your funds beyond the moment of detection." },
        ],
      },
    ],
  },
