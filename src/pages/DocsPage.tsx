    ...
    pages: [
      {
        ...
        blocks: [
          ...
          { t: "table", headers: ["File", "Purpose"], rows: [
            ...
            ["artifacts/api-server/src/lib/localos-db.ts", "DB initialization, table creation, and seed data."],
            ["artifacts/api-server/src/routes/", "Express route handlers, one file per resource."],
            ["artifacts/local-os/src/pages/AppPage.tsx", "Boot sequence and three-panel workspace layout."],
            ["artifacts/local-os/src/stores/appStore.ts", "Global UI state via Zustand."],
          ]},
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          { t: "p", v: "The model catalog is defined in the API server at artifacts/api-server/src/lib/ollama.ts." },
